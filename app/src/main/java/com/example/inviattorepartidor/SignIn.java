                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (validaciones()) {
                                ...
                                if (dataSnapshot.child(edtPhone.getText().toString()).exists()) {
                                    ...
                                    RepartidorModel repartidorModel = dataSnapshot.child(edtPhone.getText().toString()).getValue(RepartidorModel.class);
                                    repartidorModel.setPhone(edtPhone.getText().toString());
                                    if (repartidorModel.getPassword().equals(edtPassword.getText().toString())) {
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                databaseReference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        UsuarioModel usuarioModel = dataSnapshot.child(edtPhone_signUpCard.getText().toString())
